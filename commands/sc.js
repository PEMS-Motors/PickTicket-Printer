...
// Production settings
const hotFolderPath = config.hotFolder.SC;
const coldFolderPath = config.coldFolder.SC;
const safeFolderPath = config.safeFolder.SC;
const printer = config.whsPrinters.SC;
// Development settings
const devhotFolderPath = config.devhotFolder.SC;
const devcoldFolderPath = config.devcoldFolder.SC;
const devsafeFolderPath = config.devsafeFolder.SC;
const devprinter = config.devwhsPrinters.SC;
...
module.exports = {
    command_mi: function () {        
        ...
        */
        ...
        if (config.deployment.Production == 'true') {
            console.log("SC Scanning has started in production enviroment!");
        }else{
            console.log("SC Scanning has started in development enviroment!");
        }
