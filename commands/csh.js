...
// Production settings
const hotFolderPath = config.hotFolder.CSH;
const coldFolderPath = config.coldFolder.CSH;
const safeFolderPath = config.safeFolder.CSH;
const printer = config.whsPrinters.CSH;
// Development settings
const devhotFolderPath = config.devhotFolder.CSH;
const devcoldFolderPath = config.devcoldFolder.CSH;
const devsafeFolderPath = config.devsafeFolder.CSH;
const devprinter = config.devwhsPrinters.CSH;
...
module.exports = {
    command_mi: function () {        
        ...
        */
        ...
        if (config.deployment.Production == 'true') {
            console.log("CSH Scanning has started in production enviroment!");
        }else{
            console.log("CSH Scanning has started in development enviroment!");
        }
