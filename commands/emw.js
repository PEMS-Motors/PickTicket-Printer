...
// Production settings
const hotFolderPath = config.hotFolder.EMW;
const coldFolderPath = config.coldFolder.EMW;
const safeFolderPath = config.safeFolder.EMW;
const printer = config.whsPrinters.EMW;
// Development settings
const devhotFolderPath = config.devhotFolder.EMW;
const devcoldFolderPath = config.devcoldFolder.EMW;
const devsafeFolderPath = config.devsafeFolder.EMW;
const devprinter = config.devwhsPrinters.EMW;
...
module.exports = {
    command_mi: function () {        
        ...
        */
        ...
        if (config.deployment.Production == 'true') {
            console.log("EMW Scanning has started in production enviroment!");
        }else{
            console.log("EMW Scanning has started in development enviroment!");
        }
