...
// Production settings
const hotFolderPath = config.hotFolder.FL;
const coldFolderPath = config.coldFolder.FL;
const safeFolderPath = config.safeFolder.FL;
const printer = config.whsPrinters.FL;
// Development settings
const devhotFolderPath = config.devhotFolder.FL;
const devcoldFolderPath = config.devcoldFolder.FL;
const devsafeFolderPath = config.devsafeFolder.FL;
const devprinter = config.devwhsPrinters.FL;
...
module.exports = {
    command_mi: function () {        
        ...
        */
        ...
        if (config.deployment.Production == 'true') {
            console.log("FL Scanning has started in production enviroment!");
        }else{
            console.log("FL Scanning has started in development enviroment!");
        }
