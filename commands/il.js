...
// Production settings
const hotFolderPath = config.hotFolder.IL;
const coldFolderPath = config.coldFolder.IL;
const safeFolderPath = config.safeFolder.IL;
const printer = config.whsPrinters.IL;
// Development settings
const devhotFolderPath = config.devhotFolder.IL;
const devcoldFolderPath = config.devcoldFolder.IL;
const devsafeFolderPath = config.devsafeFolder.IL;
const devprinter = config.devwhsPrinters.IL;
...
module.exports = {
    command_mi: function () {        
        ...
        */
        ...
        if (config.deployment.Production == 'true') {
            console.log("IL Scanning has started in production enviroment!");
        }else{
            console.log("IL Scanning has started in development enviroment!");
        }
